setwd("E:\\Mousumi Ma'am (Project-1)\\2) Vaccinated - Review") 
...
ggsave(filename = "5) Comor 0-6 (IgG).pdf", plot = IgG_com_allANDno, width = 7, height = 3) 
...
ggsave(filename = "6) Comor 0-6 (Total).pdf", plot = tot_com_allANDno, width = 6.5, height = 3) 

setwd("E:\\Mousumi Ma'am (Project-1)\\4) Nat_Inf - Review") 
...
vaccinated <- dplyr::filter(tidydata, Vacc_status == "nat_infected") 
...
ggsave(filename = "5) Comor 0-6 (IgG).pdf", plot = IgG_com_allANDno, width = 6, height = 3) 
...
ggsave(filename = "6) Comor 0-6 (Total).pdf", plot = tot_com_allANDno, width = 6, height = 3) 
